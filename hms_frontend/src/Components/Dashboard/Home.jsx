                ...
                <div class="dashboard-card">
                    ...
                    <div class="middle">
                        ...
                        <div class="progress">
                            ...
                            <div class="number">
                                <button type="button" class="go" onClick={() => navigateTo('https://www.sakec.ac.in/')}>Go</button>
                            </div>
                        </div>
                ...
                <div class="dashboard-card">
                    ...
                    <div class="middle">
                        ...
                        <div class="progress middle-progress">
                            ...
                            <div class="number">
                                <button type="button" class="go" onClick={() => navigateTo('https://www.sakec.ac.in/admission/')}>Go</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="dashboard-card">
                    ...
                    <div class="middle">
                        ...
                        <div class="progress right-progress">
                            ...
                            <div class="number">
                                <button type="button" class="go" onClick={() => navigateTo('https://www.sakec.ac.in/student-handbook/')}>Go</button>
                            </div>
                        </div>
                    </div>
                </div>
